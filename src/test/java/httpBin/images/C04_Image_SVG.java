...
public class C04_Image_SVG extends BaseHttpBin {
    ...
    public void http() throws IOException {
        ...
        /*
Curl
curl -X GET "http://httpbin.org/image/svg" -H "accept: image/svg+xml"
Request URL
...
Response body
    ...
    @Test
    public void req() {
        RequestSpecification req=new RequestSpecBuilder().setBaseUri("http://httpbin.org/image/svg").build();
...
Response body
    ...
    @Test
    public void res() {
        specHttpbin.pathParams("pp1","image","pp2","svg");
        Response response=given()
                .spec(specHttpbin)
                .accept("image/svg+xml")
                .when()
...
Response headers
 ...
 date: Sun, 31 Jul 2022 12:08:29 GMT
